...
/** @type {string} */
const CACHE_VERSION = '1747654744|31203678840';
/** @type {string} */
const CACHE_PREFIX = 'BioShield-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'BioShield.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["BioShield.html","BioShield.js","BioShield.offline.html","BioShield.icon.png","BioShield.apple-touch-icon.png","BioShield.audio.worklet.js","BioShield.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["BioShield.wasm","BioShield.pck"];
